...
public class PersonDto {
    ...
    // requires your code to be compiled with a Java 8 compliant compiler with the -parameter flag turned on
    // with Spring Boot 2.0 or higher, this works out of the box
    @JsonCreator
